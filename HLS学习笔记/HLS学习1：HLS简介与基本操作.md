---
tags: [Import-7854]
title: HLS学习1：HLS简介与基本操作
created: '2025-07-21T08:53:52.028Z'
modified: '2025-07-23T13:01:42.965Z'
---

# HLS学习1：HLS简介与基本操作

* 本笔记致力于解释Vivado HLS的基本开发流程
...
<div align=center><img src=".\\hls1\\1.png" width = 600 >

<div align=center><img src=".\\hls1\\2.png" width = 600 >
<div align=left>
...
4.输入vivado_hls -p fir_prj，自动开启GUI，打开项目
<div align=center><img src=".\\hls1\\11.png" width = 500 >
<div align=left>
...
<div align=center><img src=".\\hls1\\4.png" width = 1200 >
...
<div align=center><img src=".\\hls1\\6.png" width = 500 >
<div align=left>
...
<div align=center><img src=".\\hls1\\7.png" width = 800 >
<div align=left>
...
<div align=center><img src=".\\hls1\\8.png" width = 500 >
<div align=left>
...
<div align=center><img src=".\\hls1\\9.png" width = 500 >
<div align=left>
...
## 3 Introduction lab3：使用解决方案优化设计（详见最优化指令）
...
* UG871第六章，Design Analysis 教程提供了对分析视角的更全面的理解。
...
* 可以对这种设计执行额外的优化。可以使用流水线pipeling来进一步提高吞吐量(throughput)并降低间隔(interval)。
* 如前所述，可以修改代码本身以使用任意精度类型。例如，如果不要求数据类型为 32 
位 int 类型，则可以使用任意精确类型(例如，6 位、14 位或 22 位类型)，前提是它们满足
所 需的精度。有关使用任意精度类型的详细信息见“任意精度类型教程”。
